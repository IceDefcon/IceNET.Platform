...
/* OUT */
#define GPIO_NUMBER_OFFLOAD_FIFO 194            // HEADER_PIN_15 :: GPIO12
#define GPIO_NUMBER_PERIPHERALS_CONFIG_DONE 38  // HEADER_PIN_33 :: GPIO13
...
typedef enum
{
    GPIO_OUT_OFFLOAD_FIFO,
    GPIO_OUT_PERIPHERALS_CONFIG_DONE,
    GPIO_OUT_RESET_FPGA,
    GPIO_OUT_AMOUNT
}outputGpioType;
