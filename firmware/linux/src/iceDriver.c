...
static void __exit fpga_driver_exit(void)
{
    ...
    //                              //
    //////////////////////////////////
    device_destroy(C_Class, MKDEV(get_majorNumber(), 0));
