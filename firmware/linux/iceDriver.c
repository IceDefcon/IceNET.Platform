...
static volatile uint8_t tx_res_buffer[] = {0xDCBA};  // Data to be transmitted for SPI0
static volatile uint8_t rx_res_buffer[1];          // Buffer to receive data for SPI0

static volatile uint8_t tx_req_buffer[] = {0xABCD};  // Data to be transmitted for SPI1
